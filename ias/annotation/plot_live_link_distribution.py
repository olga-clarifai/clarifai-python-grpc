...
def load_meta(args):
    ...
    with open(args.videos_meta, 'r') as f:
        ...
        for line in reader:
            ...
            # Extract meta
            try: # ENG
                meta = {'video_id': line['video_id'], 'url': line['video_url']}
            except: # FR/DE
                meta = {'video_id': line['video_id'], 'url': line['url']}
...
def check_links_with_ground_truth(video_ids):
    ...
    return live_links, dead_links, dead_link_count
...
def save_links(args, links, name):
...
def main(args):
    ...
    live_links, dead_links, dead_link_count = check_links_with_ground_truth(video_ids)
    ...
    # Save lists
    save_links(args, live_links, 'live_links')
    save_links(args, dead_links, 'dead_links')
